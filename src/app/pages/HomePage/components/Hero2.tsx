...
export function Hero2() {
  return (
    <div className="bg-gray-500 dark:bg-gray-800 overflow-hidden h-screen pb-14 lg:flex lg:items-center">
      <div className="w-3/4 py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      ...
      <div className="bg-gray-800 rounded-xl text-gray-100 px-8 mr-4 py-12 w-11/12">
        <div className="flex items-center gap-8">
          <img
            ...
            className="rounded-lg w-1/2 border-solid border-2 border-white"
            alt="Tree"
          />
          <div>
            <img
              src="/images/IMG-0682.jpg"
              className="rounded-lg mb-8 border-solid border-2 border-white"
              alt="Tree"
            />
            <img
              src="/images/IMG-0170.jpg"
